...
Route::post('profile/{username}/friends/sendRequest', ['as' => 'profile.friends.sendRequest', 'uses' => 'FriendsController@sendRequest']);
...
Route::post('profile/{username}/notifications/{notificationId}/dismiss', ['as' => 'profile.notifications.dismiss', 'uses' => 'NotificationsController@dismiss']);
